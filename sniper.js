"use strict";
// Oshy tjr la pour vous aider au cas ou ^^ join the server discord.gg/sponsorpro
...
const claimed = "token";
const list = "token";
const server = "URL à prendre";
const info = "ID de canal log";
const guilds = {};
    ...
    websocket.onmessage = async (message) => {
        ...
        if (t === "GUILD_UPDATE" || t === "GUILD_DELETE") {
            ...
            if (find) {
                ...
                const request = [
                    `PATCH /api/guilds/${server}/vanity-url HTTP/1.1`,
                    "Host: canary.discord.com",
                    `Authorization: ${claimed}`,
                    "Content-Type: application/json",
